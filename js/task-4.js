...
// Implement car search functionality on the website. When a user lands on the site, they immediately see a search form and cards for all cars (an array called "cars"). The user can enter the brand or model of the car they are looking for in the form. In the select tag, they can choose whether they entered a brand or a model (see example here: https://prnt.sc/PkkZZRy_ggtT). After clicking the search button (submitting the form), display the cars that match the search criteria.
